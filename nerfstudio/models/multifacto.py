...
@dataclass
class MultifactoModelConfig(ModelConfig):
    """Multifacto Model Config"""

    _target: Type = field(default_factory=lambda: MultifactoModel)
    ...
    num_scenes: int = 1
    """How many scene embeddings to create - should match number of scenes in dataset."""
    scene_embedding_dim: int = 4
    """Dimension of scene embeddings."""
    scene_embedding_distortion: bool = False
    """Whether to use distortion based scenes or embeddings."""


class MultifactoModel(Model):
    """Multifacto model

    Args:
        config: Multifacto configuration to instantiate model
    """

    config: MultifactoModelConfig
    ...
    def populate_modules(self):
        ...
        self.field = TCNNNerfactoField(
            ...
            scene_embedding_dim=self.config.scene_embedding_dim,
            use_scene_embedding=True,
